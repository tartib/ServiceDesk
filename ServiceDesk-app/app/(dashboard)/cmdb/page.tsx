            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-900 dark:text-white">{stats.totalRelationships}</p>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-900 dark:text-white">{stats.byType?.length || 0}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-gray-500 dark:text-gray-400">
              <Database className="w-12 h-12 mb-3 text-gray-300 dark:text-gray-600" />
                    ...
                    return (
                      ...
                      >
                        <td className="px-4 py-3">
                          <span className="font-mono text-xs text-gray-500 dark:text-gray-400">{item.ciId}</span>
                        </td>
                        <td className="px-4 py-3">
              ...
              {stats.byType.map((typeItem) => {
                ...
                return (
                  <button
                    ...
                    className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-3 hover:border-blue-300 dark:hover:border-blue-700 transition-colors text-center"
                  >
                    <div className={`inline-flex p-2 rounded-lg ${conf.color} mb-2`}>
                      <Icon className="w-5 h-5" />
                    </div>
                    <p className="text-sm font-medium text-gray-900 dark:text-white">{typeItem.count}</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">{isAr ? conf.labelAr : conf.label}</p>
                  </button>
                );
              })}
            </div>
