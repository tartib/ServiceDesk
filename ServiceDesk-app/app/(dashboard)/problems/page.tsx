...
const getStatusVariant = (status: ProblemStatus) => {
  const map: Record<ProblemStatus, 'info' | 'warning' | 'purple' | 'success' | 'neutral'> = {
    [ProblemStatus.LOGGED]: 'info',
    [ProblemStatus.RCA_IN_PROGRESS]: 'warning',
    [ProblemStatus.KNOWN_ERROR]: 'purple',
      ...
      <div className="space-y-6">
        ...
        {stats && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <Card className="gap-0 py-4 px-4">
              <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">{(stats as IProblemStats).knownErrors || 0}</div>
                  ...
                  {problems.map((problem: IProblem) => (
                    ...
                    >
                      <TableCell className="whitespace-nowrap">
                        ...
                        {problem.known_error && (
                          <StatusBadge variant="purple" className="ml-2">KE</StatusBadge>
                        )}
                      </TableCell>
                      <TableCell>
