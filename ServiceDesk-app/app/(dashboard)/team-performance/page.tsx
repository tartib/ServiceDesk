          ...
          <div className="bg-card rounded-xl border border-border p-4 flex flex-wrap items-center gap-3">
            <div className="relative flex-1 min-w-[200px]">
              ...
              <input
                ...
                className="w-full pl-9 pr-8 py-2 text-sm border border-input rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
              {search && (
            ...
            <select
              ...
              className="text-sm border border-input rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500"
            >
                    ...
                    <div className="flex gap-1">
                      {Array.from({ length: Math.min(pagination.totalPages, 5) }, (_, i) => i + 1).map((p) => (
                        <button
                          key={p}
                          onClick={() => fetchData(p)}
                          className={`px-3 py-1 text-sm rounded ${p === pagination.page ? 'bg-purple-600 text-white' : 'text-muted-foreground hover:bg-accent'}`}
                        >
                          {p}
                        </button>
                      ))}
