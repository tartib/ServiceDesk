                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl ${
                      unlocked ? 'bg-indigo-100 dark:bg-indigo-900/30' : 'bg-muted'
                    }`}>
                      {def.hidden && !unlocked ? (
                  ...
                  <div className="mt-3">
                    <span className={`inline-block px-2 py-0.5 rounded-full text-[10px] font-medium ${
                      def.category === 'streak' ? 'bg-orange-100 text-orange-700' :
                      def.category === 'productivity' ? 'bg-blue-100 text-blue-700' :
                      def.category === 'teamwork' ? 'bg-green-100 text-green-700' :
