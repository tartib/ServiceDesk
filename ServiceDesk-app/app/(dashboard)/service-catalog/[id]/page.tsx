...
export default function ServiceDetailPage() {
  ...
  useEffect(() => {
    const fetchService = async () => {
      try {
        setLoading(true);
        const response = await apiClient.get<{ data: Service }>(`/itsm/services/${serviceId}`);
  ...
  const handleSubmit = async () => {
    ...
    try {
      setSubmitting(true);
      await apiClient.post('/itsm/requests', {
                  ...
                  <CardContent>
                    ...
                    {service.descriptionAr && (
                      <>
                        ...
                        <p className="text-gray-700 whitespace-pre-wrap" dir="rtl">
                          {service.descriptionAr}
                        </p>
                      </>
                    )}
