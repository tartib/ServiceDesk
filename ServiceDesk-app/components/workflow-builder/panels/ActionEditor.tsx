        ...
        >
          ...
          <div className="flex items-center gap-3 pt-1 border-t border-gray-100">
            <label className="flex items-center gap-1.5">
              ...
              />
              <span className="text-[10px] text-gray-500">{isAr ? 'إعادة المحاولة' : 'Retry'}</span>
            </label>
            {action.retryOnFailure && (
              <div className="flex items-center gap-1">
                <span className="text-[10px] text-gray-400">{isAr ? 'محاولات:' : 'Max:'}</span>
                <input
                  type="number"
                  min={1}
                  max={5}
                  ...
                  className="w-10 h-5 rounded border border-gray-300 bg-white px-1 text-[10px] text-center focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
              </div>
            )}
            <label className="flex items-center gap-1.5">
              <input
                ...
                className="h-3 w-3 rounded border-gray-300"
              />
              <span className="text-[10px] text-gray-500">{isAr ? 'متابعة عند الخطأ' : 'Continue on error'}</span>
            </label>
          </div>
        </div>
      ))}
