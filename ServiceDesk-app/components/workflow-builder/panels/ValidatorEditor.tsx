    ...
    <div className="space-y-2">
      ...
      {validators.map((validator, idx) => (
        ...
        >
          ...
          {/* Error messages */}
          <div>
            <Label className="text-[10px] text-gray-400">{isAr ? 'رسالة الخطأ (EN)' : 'Error Message (EN)'}</Label>
            <Input
          ...
          <div>
            <Label className="text-[10px] text-gray-400">{isAr ? 'رسالة الخطأ (AR)' : 'Error Message (AR)'}</Label>
            <Input
