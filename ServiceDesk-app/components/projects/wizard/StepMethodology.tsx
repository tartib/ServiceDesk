...
const colorClasses: Record<string, { bg: string; border: string; text: string; light: string }> = {
 blue: { bg: 'bg-brand', border: 'border-brand', text: 'text-brand', light: 'bg-brand-surface' },
 purple: { bg: 'bg-info', border: 'border-info/50', text: 'text-info', light: 'bg-info-soft' },
 green: { bg: 'bg-success', border: 'border-success', text: 'text-success', light: 'bg-success-soft' },
 orange: { bg: 'bg-warning', border: 'border-warning/50', text: 'text-warning', light: 'bg-warning-soft' },
 teal: { bg: 'bg-success', border: 'border-success/50', text: 'text-success', light: 'bg-success-soft' },
 red: { bg: 'bg-destructive', border: 'border-destructive', text: 'text-destructive', light: 'bg-destructive-soft' },
};
...
export default function StepMethodology({ formData, updateFormData }: StepMethodologyProps) {
 ...
 <div>
 <h4 className={`font-semibold ${isSelected ? colors.text : 'text-foreground'}`}>
 {methodology.name}
 </h4>
 </div>
 </div>
 ...
 {/* Description */}
 <p className="text-sm text-muted-foreground mb-3">{methodology.description}</p>
 ...
 isSelected ? `${colors.light} ${colors.text}` : 'bg-muted text-muted-foreground'
 }`}
 >
 {feature}
 </span>
