...
export default function SubmissionsDashboard({
 ...
 <>
 {onApprove && (
 <Button variant="ghost" size="sm" className="text-success" onClick={() => onApprove(submission)}>
 <CheckCircle className="h-4 w-4" />
 </Button>
 )}
 {onReject && (
 <Button variant="ghost" size="sm" className="text-destructive" onClick={() => onReject(submission)}>
